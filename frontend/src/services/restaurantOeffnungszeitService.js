// services/restaurantOeffnungszeitService.js
...
const restaurantOeffnungszeitService = {
  ...
  /**
   * Aktive Öffnungszeiten eines Restaurants abrufen
  ...
  /**
   * Aktuelle Öffnungszeiten eines Restaurants abrufen
  ...
  create: async (assignmentData) => {
    return await apiClient.post('/api/restaurant-oeffnungszeit', assignmentData);
  },
