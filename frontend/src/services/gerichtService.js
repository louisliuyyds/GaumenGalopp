...
const gerichtService = {
    ...
    /**
     * NEU: Gerichte suchen (mit Restaurant-Info)
     * GET /gericht/search?q={query}
     */
    searchGerichte: async (query) => {
        return await apiClient.get(`/api/gericht/search?q=${encodeURIComponent(query)}`);
    },
};
