...
from backend.services.oeffnungszeit_detail_service import OeffnungszeitDetailService
from backend.schemas.oeffnungszeit_detail_schema import OeffnungszeitDetailCreate, OeffnungszeitDetailUpdate, OeffnungszeitDetailResponse
